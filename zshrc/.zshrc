...
export PATH=/opt/homebrew/bin:/Users/kevin/.nvm/versions/node/v16.17.0/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin:/Applications/Visual\ Studio\ Code.app/Contents/Resources/app/bin

export PATH=/Users/kevin/rx7/fabric-samples/bin:$PATH
export PATH=/Users/kevin/nvim-macos/bin:$PATH

export CLICOLOR=1

alias gbr="git branch | grep -v \"master\|main\|staging\|develop\|dev\" | xargs git branch -D"

# export ANDROID_HOME=/Volumes/rx7-1/android-sdk
